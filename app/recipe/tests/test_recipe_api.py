...
class PrivatecRecipeAPITests(TestCase):
    ...
    def test_create_tag_on_update(self):
        """Teste creating tag when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_ingredient_on_update(self):
        """Teste creating ingredient when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        params = {'tags': f'{tag1.name},{tag2.name}'}
    ...
    def test_filter_by_ingredients(self):
        ...
        params = {'ingredients': f'{ingredient1.name},{ingredient2.name}'}
        res = self.client.get(RECIPES_URL, params)
